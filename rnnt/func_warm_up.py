...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：rnn-transducer -> func_warm_up
@IDE    ：PyCharm
@Author ：chengli
@Date   ：2020/11/5 3:24 PM
@Desc   ：
=================================================='''
import types
import math
...
class FuncLRScheduler(_LRScheduler):
    def __init__(self, optimizer: Optimizer, lr_goal, warm_epochs, scheduler_after, last_epoch: int = -1, fns=None):
